	 ...
	 */
     function goStartMode(){
    	 ...
    	 if(sSrc.indexOf("btn_confirm2.png") < 0 ){
    		 welBtnConfirm.attr("src", CONTEXT_PATH + "/resources/scripts/smarteditor2-2.9.0/photo_uploader/img/btn_confirm2.png");
    ...
    function addImage(ofile){
		...
		if( !!bExceedLimitTotalSize ){
	        ...
	        aFileList.push('	<a onclick="delImage(\'img'+nImageInfoCnt+'\')"><img class="del_button" src="' + CONTEXT_PATH + '/resources/scripts/smarteditor2-2.9.0/photo_uploader/img/btn_del.png"  width="14" height="13" alt="첨부 사진 삭제"></a>');
			aFileList.push('	</li> ');   
    ...
    function html5Upload() {
    	...
    	sUploadURL= CONTEXT_PATH + "/upload/" + fileGroupNo + "/photo/ajax"; 	//다중 파일 업로드 URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : CONTEXT_PATH + '/upload/' + fileGroupNo + '/photo/form',	// 단일 파일 업로드 URL입니다.
